...
namespace shared_model {
  ...
  struct MockGetAccountAssets : public SpecificMockQuery<GetAccountAssets> {
    ...
    MOCK_CONST_METHOD0(paginationMeta,
                       boost::optional<const AssetPaginationMeta &>());
  ...
  struct MockAccountDetailPaginationMeta : public AccountDetailPaginationMeta {
  ...
  struct MockGetRolePermissions : public SpecificMockQuery<GetRolePermissions> {
