...
namespace shared_model {
  ...
  MockCommandFactory::constructAddAssetQuantity(
    ...
    return createFactoryResult<MockAddAssetQuantity>(
        [&asset_id,
         &asset_amount](FactoryResult<MockAddAssetQuantity> specific_cmd_mock) {
  ...
  MockCommandFactory::constructSetQuorum(const types::AccountIdType &account_id,
                                         types::QuorumType quorum) const {
    return createFactoryResult<MockSetQuorum>(
        [&account_id, quorum](FactoryResult<MockSetQuorum> specific_cmd_mock) {
          EXPECT_CALL(*specific_cmd_mock, accountId())
              .WillRepeatedly(ReturnRefOfCopy(account_id));
  ...
  MockCommandFactory::constructCompareAndSetAccountDetail(
      ...
      const shared_model::types::AccountDetailKeyType &cmd_key,
      const shared_model::types::AccountDetailValueType &cmd_value,
      const boost::optional<shared_model::types::AccountDetailValueType>
          cmd_old_value) const {
