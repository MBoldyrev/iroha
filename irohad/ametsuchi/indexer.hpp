  ...
  namespace ametsuchi {
    ...
    class Indexer {
     public:
      ...
      virtual void txHashPosition(const shared_model::types::HashType &hash,
                                  TxPosition position) = 0;

      /// Store a committed tx hash.
      virtual void committedTxHash(
          const shared_model::types::HashType &committed_tx_hash) = 0;

      /// Store a rejected tx hash.
      virtual void rejectedTxHash(
          const shared_model::types::HashType &rejected_tx_hash) = 0;
