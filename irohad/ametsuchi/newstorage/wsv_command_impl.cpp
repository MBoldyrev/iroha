...
namespace iroha {
  namespace newstorage {
    ...
    WsvCommandResult WsvCommandImpl::insertAccountRole(
    ...
    WsvCommandResult WsvCommandImpl::deleteAccountRole(
        const shared_model::interface::types::AccountIdType &account_id,
        const shared_model::interface::types::RoleIdType &role_name) {
      soci::statement st = sql_.prepare
    ...
    WsvCommandResult WsvCommandImpl::insertRolePermissions(
    ...
    WsvCommandResult WsvCommandImpl::insertAccountGrantablePermission(
    ...
    WsvCommandResult WsvCommandImpl::deleteAccountGrantablePermission(
        const shared_model::interface::types::AccountIdType
            &permittee_account_id,
        const shared_model::interface::types::AccountIdType &account_id,
        shared_model::interface::permissions::Grantable permission) {
    ...
    WsvCommandResult WsvCommandImpl::insertAccount(
    ...
    WsvCommandResult WsvCommandImpl::insertAsset(
    ...
    WsvCommandResult WsvCommandImpl::upsertAccountAsset(
    ...
    WsvCommandResult WsvCommandImpl::insertSignatory(
    ...
    WsvCommandResult WsvCommandImpl::insertAccountSignatory(
        const shared_model::interface::types::AccountIdType &account_id,
        const shared_model::interface::types::PubkeyType &signatory) {
      soci::statement st = sql_.prepare
    ...
    WsvCommandResult WsvCommandImpl::deleteAccountSignatory(
        const shared_model::interface::types::AccountIdType &account_id,
        const shared_model::interface::types::PubkeyType &signatory) {
      soci::statement st = sql_.prepare
    ...
    WsvCommandResult WsvCommandImpl::deleteSignatory(
        const shared_model::interface::types::PubkeyType &signatory) {
      soci::statement st = sql_.prepare
    ...
    WsvCommandResult WsvCommandImpl::insertPeer(
    ...
    WsvCommandResult WsvCommandImpl::deletePeer(
        const shared_model::interface::Peer &peer) {
      soci::statement st = sql_.prepare
    ...
    WsvCommandResult WsvCommandImpl::insertDomain(
    ...
    WsvCommandResult WsvCommandImpl::updateAccount(
        const shared_model::interface::Account &account) {
      soci::statement st = sql_.prepare
    ...
    WsvCommandResult WsvCommandImpl::setAccountKV(
        const shared_model::interface::types::AccountIdType &account_id,
