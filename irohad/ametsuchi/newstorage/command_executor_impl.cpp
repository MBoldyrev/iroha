...
namespace {
  ...
  iroha::expected::Error<iroha::newstorage::CommandError> makeCommandError(
...
namespace iroha {
  namespace newstorage {
    class CommandExecutorImpl::CommandStatements {
     public:
    ...
    std::unique_ptr<CommandExecutorImpl::CommandStatements>
    CommandExecutorImpl::makeCommandStatements(
    ...
    void CommandExecutorImpl::initStatements() {
      // TODO [IR-1830] Akvinikym 31.10.18: make benchmarks to compare exception
      // parsing vs nested queries
