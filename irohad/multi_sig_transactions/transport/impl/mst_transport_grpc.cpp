...
MstTransportGrpc::MstTransportGrpc(
    ...
    : async_call_(std::move(async_call)),
      ...
      log_(std::move(log)),
      client_factory_(std::move(client_factory_)) {}
...
void sendStateAsync(
    ...
    const transport::MstTransportGrpc::StubInterface &clinet_stub,
  ...
  async_call.Call([&](auto context, auto cq) {
    return clinet_stub.AsyncSendState(context, protoState, cq);
  });
}
